...
function FN_HTML_ARMAR_LISTA_SINGLE($vp_arreglo_cursos, $vp_titulo_lista, $vp_nombre_lista, $vp_valor_seleccionado, $vp_refrescar_automaticamente = false, $eventos = "OnChange='cambio_lista()",$vp_estilo="medium")
{
	// ------------------------------------------------------------------------
	$indice;
	$longitud;
	...
	for($indice = 0; $indice < $longitud; $indice ++)
	{
		$vlf_valor = $vp_arreglo_cursos[$indice];
		$vlf_titulo = $vp_arreglo_cursos[$indice];
